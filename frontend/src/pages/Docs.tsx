...
export function Docs() {
  ...
  -d '{"phoneNumber": "1234567890"}'`
        },
        {
          name: "JavaScript",
          language: "javascript",
          code: `const response = await fetch('${BASE_URL}/api/auth/register', {
  method: 'POST',
      ...
      snippets: [
        {
          name: "cURL",
          language: "bash",
          code: `curl -X POST ${BASE_URL}/api/auth/connect \\
  -H "x-api-key: YOUR_API_KEY"`
        },
        {
          name: "JavaScript",
          language: "javascript",
          code: `const response = await fetch('${BASE_URL}/api/auth/connect', {
  method: 'POST',
      ...
      snippets: [
        {
          name: "cURL",
          language: "bash",
          code: `curl ${BASE_URL}/api/auth/connect/qr \\
  -H "x-api-key: YOUR_API_KEY"`
        },
        {
          name: "JavaScript",
          language: "javascript",
          code: `const response = await fetch('${BASE_URL}/api/auth/connect/qr', {
headers: { 'x-api-key': 'YOUR_API_KEY' }
});
              ...
              snippets: [
                {
                  name: "cURL",
                  language: "bash",
                  code: `curl ${BASE_URL}/api/status \\
  -H "x-api-key: YOUR_API_KEY"`
                },
                {
                  name: "JavaScript",
                  language: "javascript",
                  code: `const response = await fetch('${BASE_URL}/api/status', {
  headers: { 'x-api-key': 'YOUR_API_KEY' }
});
...
},
{
              ...
              snippets: [
                {
                  name: "cURL",
                  language: "bash",
                  code: `curl -X POST ${BASE_URL}/api/send/text \\
  -H "Content-Type: application/json" \\
  -H "x-api-key: YOUR_API_KEY" \\
  -d '{"phoneNumber": "1234567890", "message": "Hello World!"}'`
                },
                {
                  name: "JavaScript",
                  language: "javascript",
                  code: `const response = await fetch('${BASE_URL}/api/send/text', {
  method: 'POST',
  headers: {
...
curl -N ${BASE_URL}/api/stream \\
  -H "x-api-key: YOUR_API_KEY"`
                },
                {
                  name: "JavaScript",
                  language: "javascript",
                  code: `const response = await fetch('${BASE_URL}/api/stream', {
  headers: { 'x-api-key': 'YOUR_API_KEY' }
});
...
const sidebarLinkClass = (id: string) =>
  `text-sm font-medium transition-colors flex items-center gap-2 group/link py-1 ${activeSection === id ? "text-white" : "text-slate-400 hover:text-white"
  }`;

const sidebarDotClass = (id: string) =>
  `w-1.5 h-1.5 rounded-full transition-colors ${activeSection === id ? "bg-primary-500" : "bg-white/10 group-hover/link:bg-primary-500/50"
  }`;
...
API_KEY=$(curl -s -X POST ${BASE_URL}/api/auth/register \\
  -H "Content-Type: application/json" \\
...
# Step 2: Connect
curl -X POST ${BASE_URL}/api/auth/connect \\
  -H "x-api-key: $API_KEY"

# Step 3: Get QR Code (scan with WhatsApp)
curl ${BASE_URL}/api/auth/connect/qr \\
  -H "x-api-key: $API_KEY"
